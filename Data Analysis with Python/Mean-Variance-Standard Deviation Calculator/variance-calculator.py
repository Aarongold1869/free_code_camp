...
def calculate(list):
    ...
    calculations = {
        'mean': [np.mean(m, axis=0).tolist(), np.mean(m, axis=1).tolist(), np.mean(m)],
        'variance': [np.var(m, axis=0).tolist(), np.var(m, axis=1).tolist(), np.var(m)],
        'standard deviation': [np.std(m, axis=0).tolist(), np.std(m, axis=1).tolist(), np.std(m)],
        'max': [np.amax(m, axis=0).tolist(), np.amax(m, axis=1).tolist(), np.amax(m)],
        'min': [np.amin(m, axis=0).tolist(), np.amin(m, axis=1).tolist(), np.amin(m)],
        'sum': [np.sum(m, axis=0).tolist(), np.sum(m, axis=1).tolist(), np.sum(m)]
    }
    return calculations
